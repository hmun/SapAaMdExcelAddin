...
Partial Public NotInheritable Class SapAaMdAddIn
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapAaMdAddIn As SapAaMdAddIn
    ...
    Friend Shared Property SapAaMdAddIn() As SapAaMdAddIn
        Get
            Return _SapAaMdAddIn
        End Get
        Set
            If (_SapAaMdAddIn Is Nothing) Then
                _SapAaMdAddIn = value
            Else
